...
- Basis harga sama seperti ekstraksi: **SAR / kamar QUAD (isi 4) / malam**. Kalau katalog per-orang,
  bandingkan setelah dikali 4, dan sebutkan.
...
## KONTEKS PENTING
- Kolom bulan: jan_sar..dec_sar (angka SAR untuk 1 kamar QUAD isi 4 per malam).
...
- Basis harga = SAR per kamar QUAD per malam. Jika katalog memakai harga PER ORANG, kalikan 4
  dulu sebelum membandingkan, dan sebutkan konversinya.
...
(pertahankan header dan semua 12 kolom; sel forecast/tak berubah tetap seperti CSV asli).
Header: city,tier,label,jan_sar,feb_sar,mar_sar,apr_sar,may_sar,jun_sar,jul_sar,aug_sar,sep_sar,oct_sar,nov_sar,dec_sar
