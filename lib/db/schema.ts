...
export const hotelBookingOffers = pgTable(
  "hotel_booking_offers",
  {
    ...
    rateLabel: text("rate_label").notNull().default(""),
  ...
  (t) => [
    ...
    index("hotel_booking_offers_status_window_idx").on(t.status, t.periodStart, t.periodEnd),
    index("hotel_booking_offers_sort_idx").on(t.sortOrder, t.hotelName),
  ]
)
