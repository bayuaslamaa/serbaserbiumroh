...
export async function getPublishedFaqGroups(): Promise<PublishedFaqGroup[]> {
...
export async function getPublishedFaqPreview(limit = 7): Promise<PublishedFaqItem[]> {
  return db
    .select({
      id: faqItems.id,
      groupId: faqItems.groupId,
