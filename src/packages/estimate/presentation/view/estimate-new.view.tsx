...
const parseIntParam = (value: string | undefined, min: number, max: number): number | undefined => {
...
const parseTier = (value: string | undefined): HotelTier | undefined => {
  if (value == null) return undefined;
...
export const EstimateNewView = async ({ searchParams }: { searchParams: SearchParams }) => {
      ...
      <div className="max-w-md mx-auto py-16 px-4 text-center">
        ...
        >
          ...
          <p className="text-sm text-[var(--color-text-muted)] leading-relaxed">
            Fitur perhitungan estimasi biaya umroh mandiri berbasis kecerdasan buatan (AI) sedang
            dalam tahap pengembangan dan akan segera dirilis.
          </p>
          <div className="pt-2">
