...
import type { Estimate } from '@/shared/db/schema';
import type { EstimateParams } from '@/shared/types';
...
export const EstimateCard = ({ estimate, onDelete, onDuplicate }: EstimateCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-3 text-sm" style={{ color: 'var(--color-text-muted)' }}>
        <span>
          Madinah {params.nightsMadinah} mlm + Makkah {params.nightsMakkah} mlm
        </span>
        <span>·</span>
        <span>
          {params.pax} orang · {params.roomType}
        </span>
      </div>
      ...
      >
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button variant="ghost" size="sm" style={{ color: '#e05252' }}>
              Hapus
            </Button>
          </AlertDialogTrigger>
          <AlertDialogContent style={{ background: '#0f2318', borderColor: 'var(--color-border)' }}>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={handleDelete} style={{ background: '#c03c3c' }}>
                Hapus
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
