...
const ROOM_LABELS: Record<string, string> = {
  QUINT: 'Quint (5 org/kamar)',
  QUAD: 'Quad (4 org/kamar)',
  TRIPLE: 'Triple (3 org/kamar)',
  DOUBLE: 'Double (2 org/kamar)',
};
const AIRLINE_LABELS: Record<string, string> = {
  BUDGET: 'Budget (Lion/AirAsia)',
  STANDARD: 'Batik Air',
    ...
    createElement(
        ...
        createElement(
          ...
          createElement(
            ...
            createElement(
              Text,
              { style: styles.infoValue },
              ROOM_LABELS[params.roomType] ?? params.roomType,
            ),
          ),
        ),
        createElement(
          ...
          createElement(
            ...
            createElement(
              Text,
              { style: styles.infoValue },
              AIRLINE_LABELS[params.airline] ?? params.airline,
            ),
          ),
        ),
      ),
      createElement(
        ...
        createElement(
          ...
          `Rincian Biaya per Orang${basisNote(display)}`,
        ),
        ...display.rows
          .filter((r) => !r.hidden)
          .map((r) => {
      ...
      createElement(
        ...
        createElement(
          ...
          `Digenerate: ${generatedDate}${estimateId ? ` · ID: ${estimateId}` : ''}`,
        ),
