  ...
  return (
    <div className="mx-auto max-w-6xl py-8 md:py-12 px-2">
      <section className="text-center mb-12 max-w-3xl mx-auto">
        <Badge
          variant="outline"
          className="mb-4 px-3 py-1 border-[var(--color-gold)] text-[var(--color-gold)] font-medium tracking-wide"
        >
        ...
        >
          Pengurusan visa umroh dilakukan online. Semua transaksi dan komunikasi lanjutan masih
          dilakukan melalui WhatsApp ini.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          >
            <Button
              size="lg"
              className="w-full sm:w-auto font-bold flex items-center justify-center gap-2 group transition-all duration-300 hover:shadow-lg hover:shadow-[rgba(201,168,76,0.2)]"
            >
          ...
          >
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto flex items-center justify-center gap-2 border-[var(--color-gold)] text-[var(--color-gold)] hover:bg-[var(--color-surface)]"
            >
      ...
      <section className="mb-12">
        <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 p-5 md:p-6 rounded-xl border-2 border-[var(--color-gold)] bg-gradient-to-r from-[rgba(201,168,76,0.12)] to-transparent">
          <div className="flex items-start gap-3 flex-grow">
            ...
            <div>
              ...
              <p
                ...
                style={{ color: 'var(--color-text-muted)' }}
              >
                Setelah visa terbit, pastikan status dan keasliannya lewat portal resmi Kementerian
                Luar Negeri Arab Saudi (MOFA). Siapkan nomor paspor dan nomor visa Anda.
              </p>
            </div>
          </div>
          <Link
            href={cekVisaMofaHref}
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            <Button
              size="lg"
              className="w-full md:w-auto font-bold flex items-center justify-center gap-2 group transition-all duration-300 hover:shadow-lg hover:shadow-[rgba(201,168,76,0.2)]"
            >
        ...
        <Card className="flex flex-col h-full relative overflow-hidden border-[var(--color-border)] bg-[var(--color-surface)]">
          ...
          <CardHeader className="pb-4">
            <div className="flex justify-between items-start flex-wrap gap-2 mb-2">
              ...
              <div className="text-right">
                ...
                <span className="text-[10px] text-[var(--color-text-muted)] block">
                  (include asuransi selama di Saudi)
                </span>
              </div>
            </div>
            <CardTitle
            ...
            <CardDescription
              ...
              style={{ color: 'var(--color-text-muted)' }}
            >
              Layanan reguler melalui approval hotel di Nusuk Masar untuk hotel Mekkah dan Madinah
          ...
          <CardContent className="flex-grow space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs md:text-sm">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0 mt-0.5" />
                  <span>
                    Booking hotel Mekkah & Madinah yang terdaftar di Nusuk Masar. Bisa cek
                    rekomendasi kami di{' '}
                    <Link
                      href="/hotel-nusuk"
                      target="_blank"
            ...
            <div className="p-4 rounded-lg bg-amber-950/20 border border-amber-900/30 text-xs md:text-sm space-y-2">
              ...
              <ul className="space-y-1.5 text-[var(--color-text-muted)] list-disc pl-4">
                <li>Hotel boleh dibeli melalui OTA seperti Bookingcom, Agoda, dan lainnya.</li>
                <li>
                  <strong className="text-[var(--color-text)]">WAJIB tanya ke kami</strong> sebelum
                  membeli hotel.
                </li>
                <li>
                  Hotel harus{' '}
                  <strong className="text-[var(--color-text)]">
                    non-refundable & non-free cancellation
                  </strong>
                  .
                </li>
                <li>Jumlah tempat tidur (bed) wajib sesuai dengan jumlah orang yang menginap.</li>
                <li>
                  Untuk grup dengan jumlah{' '}
                  <strong className="text-[var(--color-text)]">lebih dari 2 orang</strong>, wajib
                  menggunakan jasa transportasi penjemputan dari kami.
                </li>
              </ul>
            </div>
          </CardContent>
        ...
        <Card className="flex flex-col h-full relative overflow-hidden border-[var(--color-border)] bg-[var(--color-surface)]">
          ...
          <CardHeader className="pb-4">
            ...
            <CardDescription
              ...
              style={{ color: 'var(--color-text-muted)' }}
            >
              Tanpa melalui approval hotel yang dibeli, sehingga biasanya perlu membeli BRN hotel
              lain.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="flex-grow space-y-6">
            ...
            <div className="p-3 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] text-xs md:text-sm">
              ...
              <p className="text-[var(--color-text-muted)] mb-2">
                Layanan ini biasanya dipilih ketika approval hotel yang dibeli tidak memungkinkan
                karena:
              </p>
              ...
              <ul className="space-y-2 text-xs md:text-sm">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="leading-tight">
                    Booking hotel Mekkah & Madinah yang terdaftar di web Kementerian Pariwisata
                    Saudi. Hotel boleh dibeli melalui OTA seperti Bookingcom, Agoda, dan lainnya.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-3 rounded-lg bg-[var(--color-surface)] border border-[var(--color-border)] text-xs md:text-sm flex items-start gap-2">
              ...
              <p className="text-[var(--color-text-muted)]">
                Untuk rombongan{' '}
                <strong className="text-[var(--color-text)]">lebih dari 2 orang</strong>, disarankan
                sekalian mengambil jasa transportasi penjemputan dari kami agar memudahkan
          ...
          <CardContent className="text-xs md:text-sm space-y-4">
            <div>
              <h5 className="font-semibold text-[var(--color-text)] mb-2">
                Persyaratan Tambahan Siskopatuh:
              </h5>
      ...
      <section className="mb-12 p-6 rounded-lg border border-[var(--color-border)] bg-black/25">
        <h3
          ...
          style={{ color: 'var(--color-gold)', fontFamily: 'var(--font-heading)' }}
        >
          <AlertTriangle className="w-5 h-5 text-[var(--color-gold)]" /> Catatan Penting Sebelum
          Pengajuan
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs md:text-sm">
          <div className="space-y-3">
            <div>
              <h5 className="font-bold text-[var(--color-text)] mb-1">
                Mengenai Tiket Penerbangan
              </h5>
              <p style={{ color: 'var(--color-text-muted)' }}>
                Pastikan tiket Anda adalah tiket Pulang Pergi (PP) yang valid. Tiket satu arah
                (one-way) tidak diperbolehkan dan dapat menyebabkan penolakan visa.
              </p>
            </div>
            <div>
              <h5 className="font-bold text-[var(--color-text)] mb-1">
                Ketentuan Hotel di Nusuk Masar
              </h5>
              <p style={{ color: 'var(--color-text-muted)' }}>
                Khusus untuk Layanan 1 (Nusuk Masar), pastikan hotel tempat Anda memesan terdaftar
                secara resmi dan mau memberikan approval. Disarankan untuk menanyakan ke pihak kami
                terlebih dahulu sebelum melakukan transaksi booking.
              </p>
            </div>
          </div>
          <div className="space-y-3">
            <div>
              ...
              <p style={{ color: 'var(--color-text-muted)' }}>
                Seluruh pengurusan visa sudah include (termasuk) biaya asuransi kesehatan wajib dari
                Kementerian Kesehatan Arab Saudi selama periode berada di Saudi.
              </p>
            </div>
            <div>
              <h5 className="font-bold text-[var(--color-text)] mb-1">
              ...
              <p style={{ color: 'var(--color-text-muted)' }}>
                Seluruh proses pembayaran, verifikasi dokumen, dan konfirmasi akhir dilakukan
                melalui chat admin WhatsApp resmi kami.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="text-center py-8 px-4 rounded-xl border border-[var(--color-gold-muted)] bg-gradient-to-b from-[rgba(201,168,76,0.05)] to-transparent max-w-4xl mx-auto">
        ...
        <p
          className="text-xs md:text-sm max-w-xl mx-auto mb-6"
          style={{ color: 'var(--color-text-muted)' }}
        >
          Persiapkan scan paspor, tiket PP, dan kelengkapan booking hotel Anda. Ajukan lewat
          aplikasi kami atau konsultasikan dulu melalui WhatsApp.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            href={visaAppHref}
          ...
          >
            <Button
              variant="outline"
              size="lg"
              className="w-full sm:w-auto border-[var(--color-gold)] text-[var(--color-gold)] hover:bg-[var(--color-surface)]"
            >
              <MessageCircle className="w-4 h-4" />
