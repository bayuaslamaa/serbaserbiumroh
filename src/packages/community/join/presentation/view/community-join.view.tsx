...
import {
  ...
  hasAnyGroupUrl,
  type SsuGroup,
} from '@/packages/community/domain/groups';
...
const withPrefilledText = (url: string, message: string) => {
  try {
...
const activityLabel = (group: SsuGroup) => {
...
const GroupRow = ({ group }: { group: SsuGroup }) => {
...
export const CommunityJoinForm = ({ adminChatUrl }: CommunityJoinFormProps) => {
    ...
    return (
      ...
      >
        ...
        <p className="mt-3 text-sm leading-relaxed" style={{ color: 'var(--color-text-muted)' }}>
          ...
          Ini membantu admin mencocokkan pengajuan Kakak dengan data form. Persetujuan tetap
          mengikuti pengecekan admin.
        </p>
  ...
  return (
    ...
    >
      ...
      <p className="mt-5 text-xs leading-relaxed" style={{ color: 'var(--color-text-muted)' }}>
        Setelah dikirim, Kakak bisa memilih grup SSU yang ingin dimasuki dan menghubungi admin.
        Pastikan nama dan nomor HP sama saat mengajukan lewat WhatsApp.
      </p>
