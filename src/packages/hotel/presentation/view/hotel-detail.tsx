...
import type { HotelDetail as HotelDetailData } from '@/packages/hotel/domain/detail';
import {
  MONTH_NAMES_FULL,
  formatCompactIdr,
  formatFullIdr,
...
import { CITY_LANDMARK, TIER_LABEL, bookingLinks } from '@/packages/hotel/domain/presentation';

export const HotelDetail = ({ hotel }: { hotel: HotelDetailData }) => {
    ...
    <article className="mx-auto max-w-4xl">
      ...
      >
        <ol className="flex flex-wrap items-center gap-1.5">
          ...
          <li aria-hidden>/</li>
          <li>
            <Link href="/hotel-nusuk" className="hover:underline">
              Hotel Nusuk
            </Link>
          </li>
          <li aria-hidden>/</li>
      ...
      <section className="mb-8 hidden">
        ...
        <p className="mb-4 text-xs" style={{ color: 'var(--color-text-muted)' }}>
          Kurs acuan 1 SAR = {formatFullIdr(hotel.exchangeRate)}. Bulan bertanda titik memakai harga
          musiman, bukan harga dasar.
        </p>
        ...
        <p className="mt-3 text-xs" style={{ color: 'var(--color-text-muted)' }}>
          Harga dasar {hotel.sarPerNight} SAR (
          {formatCompactIdr(hotel.sarPerNight * hotel.exchangeRate)}) per malam. Angka di atas
          adalah estimasi untuk perencanaan, bukan penawaran yang mengikat — harga final mengikuti
          tarif saat pemesanan.
        </p>
      </section>
        ...
        <section className="mb-8">
          ...
          {hotel.editorial.facilities && (
            <p
              ...
              style={{ color: 'var(--color-text-muted)' }}
            >
              <span style={{ color: 'var(--color-text)' }}>Fasilitas:</span>{' '}
              {hotel.editorial.facilities}
            </p>
          )}
