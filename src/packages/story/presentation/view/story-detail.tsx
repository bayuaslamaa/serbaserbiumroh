...
import type { PilgrimStory, StoryItineraryDay, StoryPackingItem } from '@/shared/db/schema';
...
const getGroupSizeLabel = (pax: number): string => {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      {isAdmin ? (
        ...
        <div
          className="mb-8 p-4 rounded-lg opacity-60"
          style={{
            backgroundColor: 'rgba(255,255,255,0.03)',
            borderColor: 'var(--color-border)',
            border: '1px solid',
      ...
      <section className="mb-8">
        ...
        <p className="text-xs mt-2" style={{ color: 'var(--color-text-muted)' }}>
          {story.pax} orang · {story.makkahNights} malam Makkah · {story.madinahNights} malam
          Madinah · Hotel {story.hotelTier}
        </p>
      </section>
    </div>
  );
