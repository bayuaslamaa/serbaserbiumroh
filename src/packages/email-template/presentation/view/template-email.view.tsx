...
import { EmailTemplateCard } from '@/packages/email-template/presentation/view/email-template-card';
import { emailTemplates, type EmailTemplate } from '@/packages/email-template/domain/content';

const groupByInstitution = (templates: EmailTemplate[]) => {
...
export const TemplateEmailView = () => {
