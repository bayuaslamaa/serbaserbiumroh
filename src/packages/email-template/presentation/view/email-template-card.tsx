...
import { CopyButton } from '@/packages/email-template/presentation/view/copy-button';
import { Input } from '@/components/atoms/input';
import { Label } from '@/components/atoms/label';
import { BODY_LANGUAGE_LABEL, type EmailTemplate } from '@/packages/email-template/domain/content';
import { buildMailtoHref, renderBody } from '@/packages/email-template/domain/render';
...
const MetaRow = ({ label, value, describes }: MetaRowProps) => {
  return (
...
export const EmailTemplateCard = ({ template }: EmailTemplateCardProps) => {
