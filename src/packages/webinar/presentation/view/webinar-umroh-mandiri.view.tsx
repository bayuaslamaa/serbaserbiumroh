...
import { socialHref } from '@/packages/layanan/domain/contact';
import {
  WEBINAR_ACCESS_NOTE,
  WEBINAR_DATE_LABEL,
  WEBINAR_PATH,
...
export const WebinarUmrohMandiriView = async () => {
    ...
    <div className="mx-auto max-w-5xl">
      <section className="grid gap-8 py-8 lg:grid-cols-[1fr_0.8fr] lg:items-start lg:py-12">
        <div>
          ...
          >
            Ikuti sesi webinar untuk memahami alur persiapan, estimasi biaya, pilihan hotel,
            transportasi, dan hal penting yang perlu dicek sebelum berangkat mandiri.
          </p>
          ...
          >
            <div className="flex gap-2.5 items-start">
              ...
              <div className="space-y-1.5">
                ...
                >
                  Kapasitas Zoom{' '}
                  <strong className="text-[var(--color-text)]">hanya untuk 300 peserta</strong>.
                  Ruang Zoom akan dibuka 15-30 menit sebelum acara dimulai pukul{' '}
                  {WEBINAR_TIME_LABEL}, dan admin akan menyetujui (accept) peserta masuk secara
                  acak.
                </p>
              </div>
            </div>
          ...
          {isLoggedIn && rsvpUrl ? (
            ...
            <>
              <p
                ...
                style={{ color: 'var(--color-text-muted)' }}
              >
                Login dulu untuk melihat link RSVP. Setelah masuk, Kakak akan diarahkan kembali ke
                halaman ini.
              </p>
              <Link
                href={`/login?callbackUrl=${encodeURIComponent(WEBINAR_PATH)}`}
