...
import type { PilgrimStoryImportParseResult } from '@/packages/admin/domain/pilgrim-story-import';

type StoryImportPanelProps = {
  onImported?: () => void;
};

export const StoryImportPanel = ({ onImported }: StoryImportPanelProps) => {
    ...
    >
      ...
      <div className="space-y-4 border-t p-5" style={{ borderColor: 'var(--color-border)' }}>
        <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
          Kolom CSV: slug, author_name, departure_city, pax, hotel_tier, total_budget_idr, dan
          metadata perjalanan.
        </p>
...
const StoryImportPreview = ({ preview }: { preview: PilgrimStoryImportParseResult }) => {
  return (
