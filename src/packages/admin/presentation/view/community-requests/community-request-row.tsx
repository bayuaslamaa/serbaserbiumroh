...
import type { CommunityJoinRequestWithDuplicateFlags } from '@/packages/community/admin-requests/domain/admin-requests';
import {
  formatAbsoluteDateTime,
  formatPhoneDisplay,
  formatRelativeTime,
  whatsappHref,
} from '@/packages/community/admin-requests/domain/admin-requests-format';
import {
  statusBadgeVariant,
  statusLabel,
} from '@/packages/community/admin-requests/domain/admin-requests-status';

const duplicateReason = (request: CommunityJoinRequestWithDuplicateFlags) => {
...
export const CommunityRequestRow = ({ request }: CommunityRequestRowProps) => {
  return (
