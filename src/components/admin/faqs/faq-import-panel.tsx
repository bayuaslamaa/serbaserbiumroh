...
import type { FaqImportParseResult } from "@/shared/admin/faq-import"

type FaqImportPanelProps = {
  onImported?: () => void
}

export function FaqImportPanel({ onImported }: FaqImportPanelProps) {
...
function FaqImportPreview({ preview }: { preview: FaqImportParseResult }) {
  return (
