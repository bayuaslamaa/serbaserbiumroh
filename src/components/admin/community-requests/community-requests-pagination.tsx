...
import { PAGE_SIZE, type RawSearchParams } from "@/shared/community/admin-requests-query"
import { buildAdminRequestsHref } from "@/shared/community/admin-requests-url"
...
/**
 * A Server Component on purpose: paging holds no client state, it just moves
 * the `page` param, so plain links keep the whole list on the server.
 */
export function CommunityRequestsPagination({
  page,
  pageCount,
  total,
  searchParams,
