...
import { buildWhatsAppMessage } from "@/shared/export/whatsapp"
...
// Mobile-only WA preview: EstimatorRail's own panel only mounts on desktop (it wraps the whole
// rail), so mobile needs this in-flow equivalent, rendered above MobileTotalBar when waOpen.
export function MobileWaPanel({ display, params, pax }: MobileWaPanelProps) {
