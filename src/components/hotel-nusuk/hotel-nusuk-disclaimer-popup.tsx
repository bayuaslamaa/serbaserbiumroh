...
export function HotelNusukDisclaimerPopup() {
  ...
  useEffect(() => {
    ...
    // Show popup with slight delay for page to settle
    const t = setTimeout(() => {
      setVisible(true)
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, var(--color-gold,#c9a84c), #f0d080, var(--color-gold,#c9a84c))' }}
        />
        ...
        <div className="p-6">
          ...
          <ul className="space-y-3.5 mb-6">
            {[
              {
                icon: <Info className="h-4 w-4 flex-shrink-0 mt-0.5" style={{ color: '#f0d080' }} />,
                text: (
                  <>
                    ...
                    <span style={{ color: 'var(--color-text-muted)' }}>
                      untuk keperluan <em>planning</em> perjalanan umroh, bukan harga resmi atau jaminan ketersediaan kamar.
                    </span>
                  </>
                ),
              },
              {
                icon: <CheckCircle className="h-4 w-4 flex-shrink-0 mt-0.5" style={{ color: '#4caf85' }} />,
                text: (
                  <>
                    <span className="font-semibold" style={{ color: 'var(--color-text)' }}>
                    ...
                    <span style={{ color: 'var(--color-text-muted)' }}>
                      dan sesuai rekomendasi kami — sehingga proses approval untuk travel agent lebih mudah dan lancar.
                    </span>
                  </>
                ),
              },
              {
                icon: <ExternalLink className="h-4 w-4 flex-shrink-0 mt-0.5" style={{ color: '#6b9de8' }} />,
                text: (
                  <>
                    <span className="font-semibold" style={{ color: 'var(--color-text)' }}>
                      Untuk harga aktual
              ...
              {
                icon: <MessageCircle className="h-4 w-4 flex-shrink-0 mt-0.5" style={{ color: '#a78bfa' }} />,
                text: (
                  <span style={{ color: 'var(--color-text-muted)' }}>
