...
import { adminLinks } from '@/shared/nav-links';
    ...
    <div className="relative" data-nav-menu="account">
      ...
      {isOpen && (
        <MenuPanel align="right" width="240px">
          ...
          >
            {userName && <div className="text-[13px] font-semibold text-text">{userName}</div>}
            {userEmail && <div className="truncate text-[11px] text-text-muted">{userEmail}</div>}
          </div>
