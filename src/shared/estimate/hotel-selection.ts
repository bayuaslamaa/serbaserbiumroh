import type { City, EstimateParams, HotelOptionConfig, HotelTier, PricingConfig } from "@/shared/types"
...
export function resolveCityHotelOptions(pricing: PricingConfig, city: City): HotelOptionConfig[] {
