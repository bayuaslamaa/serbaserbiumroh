...
import { FaqGroupForm } from "@/components/admin/faqs/faq-group-form"
import { FaqImportPanel } from "@/components/admin/faqs/faq-import-panel"
...
function truncate(text: string, length = 90) {
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--color-text-muted)" }}>
            {faqs.length} pertanyaan tersimpan, {faqs.filter((faq) => faq.isPublished).length} publik.
          </p>
        </div>
        <Link
